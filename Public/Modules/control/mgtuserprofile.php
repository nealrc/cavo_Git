...
<script type="text/javascript" src="../logic/cdock.user.pack.js"></script>
<!-- InstanceEndEditable -->
</head>
<body>
<div id="container">
    <div id='content-wrapper'>
        ...
        <p style="text-align:right"><a href="mgtuserscore.php">User Test Record Management</a></p>
<div class='helpNotes'>(Use the buttons <img src="../../../Assets/images/buttonHelp1.gif" width="116" height="22" /> on the lower-left corner of the table to navigate.)</div>
      	<div id='tablewrapper'>
