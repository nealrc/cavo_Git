...
<link rel="stylesheet" type="text/css" href="../../../Assets/js/jquery.jqGrid-3.8/css/ui.jqgrid.css"/>
<link rel="stylesheet" type="text/css" href="../../../Assets/css/table_override.css"/>
<link rel="stylesheet" type="text/css" href="../../../Assets/css/cdock.archive.table.css"/>
<script type="text/javascript" src="../../../Assets/js/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="../../../Assets/js/jquery.blockui.min.js"></script>
<script type="text/javascript" src="../../../Assets/js/jquery.ui/js/jquery-ui-1.8.5.custom.min.js"></script>
<script type="text/javascript" src="../../../Assets/js/jquery.jqGrid-3.8/js/i18n/grid.locale-en.js"></script>
<script type="text/javascript" src="../../../Assets/js/jquery.jqGrid-3.8/js/jquery.jqGrid.min.js"></script>
<script type="text/javascript" src="../logic/cdock.main.pack.js"></script>
<script type="text/javascript" src="../logic/cdock.usersc.pack.js"></script>
<!-- InstanceEndEditable -->
</head>
<body>
<div id="container">
    <div id='content-wrapper'>
        ...
        <h1>User Test Record Management</h1>
        <p style="text-align:right"><a href="mgtuserprofile.php">User Profile Management</a></p>
<div class='helpNotes'>(Use the buttons <img src="../../../Assets/images/buttonHelp.gif" width="65" height="22" /> on the lower-left corner of the table to navigate.)</div>
        <div id='tablewrapper'>
            <table id="userscoretable"></table>
            <div id="navpager"></div>        
        </div>
        
        <div id='singlerecordinfo'>
            <div id="bodywrapper"></div>
            <div style="clear:both;"></div>
            <div id="buttonwrapper">            
                <div class="navbuttonwrapper">
                    <a id="btnnext" class="ui-state-default ui-corner-right" href="javascript:void(0)">
                        <span class="ui-icon ui-icon-triangle-1-e"></span></a>						
                    <a id="btnpre" class="ui-state-default ui-corner-left" href="javascript:void(0)">
