...
<div id="container">
    <div id='content-wrapper'>
        ...
        <?php if($_SESSION['MM_UserGroup']==$role['admin'] || $_SESSION['MM_UserGroup']==$role['instructor']){ ?>
        <blockquote>
          <h2>Institue Report</h2>
        </blockquote>
        <ul>                
            <li id='d'>
                <a href="compireport.php">Institute report</a></li>
        </ul>
		<?php } ?>
        ...
        <ul>
          <li id='a'>
            <a href="compreport.php">My CAVO comprehensive report</a></li>
          <li id='b'>
            <a href="archive.php">My test record</a></li>            
          <li id='c'>
            <a href="chart.php">My score charts</a></li>
        </ul>
        </div>
		<!-- InstanceEndEditable -->
            </div>
