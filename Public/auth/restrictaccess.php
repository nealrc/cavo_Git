    ...
    <div id='content-wrapper'>
        ...
        <!-- InstanceBeginEditable name="content" -->
   			<div class="fancybox-wrapper">
            	<div class="fancybox-y-top"><h1>Access Denied</h1></div>
				<div class="fancybox-content">
                    <div class='smallbox'>
                        <h2>Your are not allowed to access this page. </h2>
                        <p>If you believe this is an error, please contact your program manager or Chinese Flagship Program at the Ohio State University for support. </p>
                        <p>Please note that your account might need to be activated before you can access your pages if you have registered as an <b>Instructor</b> or <b>Editor</b></p>
                        <p>Thank you.</p>
                    </div>
				</div>
