    ...
    <div id='content-wrapper'>
        ...
        <!-- InstanceBeginEditable name="content" -->        
   			<div class="fancybox-wrapper">
            	<div class="fancybox-top"><h1>Logout Success</h1></div>
				<div class="fancybox-content">
                    <div class='smallbox'>
                        <h2>You have logged out of CAVO. </h2>
                        <p>All cookies have been deleted.</p>
                        <p>Click <strong><a href="../../index.php">Home</a></strong> to go back.</p>
                        <p>Thank you for using CAVO! Come back soon.</p> 
                    </div>
				</div>
